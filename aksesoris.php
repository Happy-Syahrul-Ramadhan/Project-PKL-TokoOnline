<?php 
 ...
 <div class="jumbotron text-light bg-primary" style="padding: 20px 0; margin-top: 55px;">
 	<div class="container text-center">
 		<h2 style="font-weight: bold;">Total Semua Aksesoris (<?php echo mysqli_num_rows(mysqli_query($koneksi, "select*from produk where id_kategori=9 order by id_produk")); ?>)Items </h2>
 	</div>
 </div>
 ...
 <!-- produk Baru -->
	...
	<div class="w3-row container mt-5 mx-auto">
		...
		<?php 
	      $query = mysqli_query($koneksi, "select*from produk where id_kategori=9 order by id_produk desc");
